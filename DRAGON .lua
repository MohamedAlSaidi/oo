...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹S H A D O W˼', url="t.me/KB_Shadow"},{text = '˹S E Z E R˼', url="t.me/s_e_z_r0"}},
...
if text == '𝐕𝘼𝙈𝘽𝙄𝙍' or text == 'فمبير' or text == 'المبرمج فمبير' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 2093265110,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'المبرمج 🌚💘\n['..result.first_name_..'](t.me/XxlllllllllllllllllllllllllllxX)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 2093265110, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
if text == 'استوري فمبير' or text == 'كوكب فمبير' or text == 'قناه المبرمج فمبير' or text == 'متيجي' or text == 'متيقي' then
local Text = [[
متيقي هنا دي بقي الكوكب الخاص بالمبرمج فمبير
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑷𝑳𝑨𝑵𝑬𝑻 𝐕𝘼𝙈𝘽𝙄𝙍🏂💖',url="t.me/XxvprxX"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[رتبتك المبرمج فمبير🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[بنت المبرمج فمبير🥺💘](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
keyboard.inline_keyboard = {
{{text = 'S H A D O W',url="t.me/KB_Shadow"},{text = 'S E Z E R', url="t.me/s_e_z_r0"}},
{{text = ' بوت شادو',url="t.me/USDDBOT"},{text = 'بوت فمبير', url="t.me/VPllllllllllllbot"}},
